...
export class HotelVehicleComponent implements OnInit {
  ...
  async travelRequestFn(travelRequestId){  
   ...
   console.log('D', d);
   const [f] = [...d];
   this.accommodationStartDate = new Date(`${f.accommodationStartDateMM}-${f.accommodationStartDateDD}-${f.accommodationStartDateYYYY}`);
   //  console.log('accommodationStartDate', accommodationStartDate);
     this.accommodationEndDate = new Date(`${f.accommodationEndDateMM}-${f.accommodationEndDateDD}-${f.accommodationEndDateYYYY}`);
   //  console.log('accommodationEndDate', accommodationEndDate);

   this.vehicleConfig = this.requestsService.vehicleForFlightsConfigFn(this.accommodationStartDate, this.accommodationEndDate);

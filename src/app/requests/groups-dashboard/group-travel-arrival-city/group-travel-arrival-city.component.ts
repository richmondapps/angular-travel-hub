...
export class GroupTravelArrivalCityComponent implements OnInit {
  ...
  showAddGroupTravelNameFn(){
    this.showAddGroupTravelArrivalCityInput = !this.showAddGroupTravelArrivalCityInput;
    this.formConfig = this.groupTravelService.groupTravelArrivalCityAndStartDateFn();
  }
  ...
  startOverFn(){
    ...
    async submittedFormData(d: any) {
      ...
      const a = this.dateTimeService.returnExtractedDatesFn('groupRequest', d.groupRequestEventStartDate)
      const formData = {  
        ...d,
        ...a,
      ...
      try {
        ...
        this.groupTravelDocId,
         ...
         sessionStorage.setItem('GroupTravelDocId', JSON.stringify(this.groupTravelDocId));
         sessionStorage.setItem('GroupTravelCity', JSON.stringify(this.groupTravelArrivalCity));
         localStorage.setItem('GroupTravelDocId', JSON.stringify(this.groupTravelDocId));
